...
export const EditStudentForm: React.FC<EditStudentFormProps> = ({
  ...
  const [parentName, setParentName] = useState(student.contactParent.name);
  const [parentPhone, setParentPhone] = useState(student.contactParent.phone);
  const [parentEmail, setParentEmail] = useState(student.contactParent.email);
