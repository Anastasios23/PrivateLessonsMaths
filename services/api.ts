...
import { Student, Session, Homework, ProgressNote, Assessment } from "../types";
...
export const api = {
  ...
  getAssessments: (): Promise<Assessment[]> => simulateDelay(MOCK_ASSESSMENTS),
  getAssessmentsByStudentId: (studentId: string): Promise<Assessment[]> =>
    simulateDelay(MOCK_ASSESSMENTS.filter((a) => a.studentId === studentId)),
};
